        ...
        <Head>
          <Row>
            {props.columns.map((col) => {
              ...
              return (
                <Cell key={col} style={{ whiteSpace: "nowrap" }}>
                  {col}
                </Cell>
              );
            })}
              ...
              <Row key={r.key}>
                {props.columns.map((col) => {
                  ...
                  const valueToCopy =
                    typeof cell === "string"
                      ? cell
                      : typeof cell === "object" && sortValue in cell
                      ? cell[sortValue] ?? null
                      : null;
                  ...
                  const cellValueParsed =
                    typeof cell === "string"
                      ? cell
                      : typeof cell === "object" && cellValue in cell
                      ? cell[cellValue]
                      : cell;
                  ...
                  return (
                    <Cell key={key}>
                      ...
                      {valueToCopy !== null && (
                        <Tooltip title="Copied!" placement="top" reactOnClick>
                          <IconButton onClick={() => copy(valueToCopy)}>
                            <ContentCopyIcon
                              style={{
                                width: "13px",
                                height: "13px",
